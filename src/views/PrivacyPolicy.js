    ...
    <Layout hideUserMenu>
      ...
      <Container>
        <Segment>
          ...
          <p>
            Your privacy is important to us. It is Octoboards&#39; policy to respect your privacy
            ...
            <a href={CLIENT_URL}>{CLIENT_URL}</a>, and other sites we own and operate.{" "}
          </p>
          <p>
            This policy is effective as of 19 April 2021 and was last updated on 19 April 2021.{" "}
          </p>
          ...
          <Header as="h4">Legitimate Reasons for Processing Your Personal Information</Header>
          <p>
          ...
          <Header as="h4">Collection and Use of Information</Header>
          <p>
          ...
          <Header as="h4">Security of Your Personal Information</Header>
          <p>
          ...
          <Header as="h4">How Long We Keep Your Personal Information</Header>
          <p>
          ...
          <Header as="h3">Disclosure of Personal Information to Third Parties</Header>
          ...
          <Header as="h3">International Transfers of Personal Information</Header>
          <p>
            ...
            information. If we transfer your personal information to third parties in other
            countries: (i) we will perform those transfers in accordance with the requirements of
            applicable law; and (ii) we will protect the transferred personal information in
            accordance with this privacy policy.{" "}
          </p>
          <Header as="h3">Your Rights and Controlling Your Personal Information</Header>
          <p>
            ...
            information. If you do provide us with personal information you understand that we will
            collect, hold, use and disclose it in accordance with this privacy policy. You retain
            the right to request details of any personal information we hold about you.{" "}
          </p>
          <p>
            ...
            about somebody else, you represent and warrant that you have such person’s consent to
          ...
          <Header as="h3">Use of Cookies</Header>
          <p>
            We use &ldquo;cookies&rdquo; to collect information about you and your activity across
            our site. A cookie is a small piece of data that our website stores on your computer,
            and accesses each time you visit, so we can understand how you use our site. This helps
            us serve you content based on preferences you have specified.{" "}
          </p>
          <Header as="h3">Limits of Our Policy</Header>
          <p>
          ...
          <Header as="h3">Changes to This Policy</Header>
          <p>
          ...
          <p>
            Octoboards Team
            <br />
            <a href="mailto:hello@octoboards.com">hello@octoboards.com</a>{" "}
          </p>
        </Segment>
      </Container>
    </Layout>
